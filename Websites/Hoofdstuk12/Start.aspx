...
<body>
    <form id="form1" runat="server">
        ...
        <div id="overzicht">
            <h2>Afspraken</h2>
            <p>
                <asp:ListBox ID="lbBerichten" runat="server" Height="168px" OnSelectedIndexChanged="lbBerichten_SelectedIndexChanged2" Width="690px"></asp:ListBox>
            </p>
        </div>
        <div id="knoppen">
            <asp:ImageButton ID="btnBewaren" runat="server" Height="60px" ImageUrl="images/Toevoegen.png" Width="60px" OnClick="btnBewaren_Click" />
            <asp:ImageButton ID="btnAnnuleren" runat="server" Height="60px" ImageUrl="images/Annuleren.png" Width="60px" OnClick="btnAnnuleren_Click" />
        </div>
    </form>
</body>
</html>
