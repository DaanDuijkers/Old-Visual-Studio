...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:SqlDataSource ID="sdsSchoolNaam" runat="server" ConnectionString="<%$ ConnectionStrings:TennistoernooiConnectionString %>" SelectCommand="SELECT [School_Naam] FROM [SCHOOL]"></asp:SqlDataSource>
        </td>
    </tr>
</table>
<br />
...
<br />
<asp:GridView ID="grdSpelers" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="sdsSpelers">
    <Columns>
    ...
    <asp:SqlDataSource ID="sdsSpelers" runat="server" ConnectionString="<%$ ConnectionStrings:TennistoernooiConnectionString %>" DeleteCommand="DELETE FROM [SPELER] WHERE [Id] = @Id" InsertCommand="INSERT INTO [SPELER] ([Speler_Voornaam], [Speler_Tussenvoegsel], [Speler_Achternaam], [School_Id]) VALUES (@Speler_Voornaam, @Speler_Tussenvoegsel, @Speler_Achternaam, @School_Id)" SelectCommand="SELECT * FROM [SPELER]" UpdateCommand="UPDATE [SPELER] SET [Speler_Voornaam] = @Speler_Voornaam, [Speler_Tussenvoegsel] = @Speler_Tussenvoegsel, [Speler_Achternaam] = @Speler_Achternaam, [School_Id] = @School_Id WHERE [Id] = @Id">
        <DeleteParameters>
